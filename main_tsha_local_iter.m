...
%                    选择没有触发
    ...
    for i=1:pop 
        ...
        sum_tt=ceil(sum_tt/sum(implement(1:actNo)));
...
outFile=[fpathRoot,groupdata,'\',num2str(end_schedules),'sch_',setName,'_dtime_',dt,'_tsha_iter_para1','.txt'];
outFile1=[fpathRoot,groupdata,'\',num2str(1000),'sch_',setName,'_dtime_',dt,'_tsha_iter_para1','.txt'];
outFile2=[fpathRoot,groupdata,'\',num2str(3000),'sch_',setName,'_dtime_',dt,'_tsha_iter_para1','.txt'];
